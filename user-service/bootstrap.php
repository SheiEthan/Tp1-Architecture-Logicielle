...
// Bootstrap pour microservice Utilisateur
...
class DB {
    ...
    public static function getConnection() {
        if (self::$pdo === null) {
            $host = $_ENV['DB_HOST'] ?? 'mysql_users';
            $db = $_ENV['DB_DATABASE'] ?? 'tp3_users';
...
function app($class) {
    ...
    if ($class === \Application\Ports\IUserApiRepository::class) {
        return new \Persistence\PDOUserApiRepository();
    }
